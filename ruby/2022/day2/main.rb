...
class RockPaperScissors
  ...
  def score(player0, player1)
    ...
    return SIGN_SCORES.index(player1) + 7 if STRATEGIES.key(player0) == player1
  end
...
solver = RockPaperScissors.new(ARGF.readlines)
pp "PART I: #{solver.solve1}"
pp "PART I: #{solver.solve2}"
